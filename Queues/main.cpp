...
int main() {
    ...
    test_true(q.front() == 'a', "Queue front element is 'a'.");
    /*pass*/test_true(q.dequeue(), "Successful dequeue of 'a'.");
    test_true(q.front() == 'b', "Queue front element is 'b'.");
    /*pass*/test_true(q.dequeue(), "Successful dequeue of 'b'.");
    test_true(q.front() == 'c', "Queue front element is 'c'.");
    /*pass*/test_true(q.dequeue(), "Successful dequeue of 'c'.");
    test_true(q.front() == 'd', "Queue front element is 'd'.");
    /*pass*/test_true(q.dequeue(), "Successful dequeue of 'd'.");
    test_true(q.front() == 'e', "Queue front element is 'e'.");
    /*pass*/test_true(q.dequeue(), "Successful dequeue of 'a'.");
    /*pass*/test_true(q.is_empty(), "Queue is empty after dequeuing many elements.");
